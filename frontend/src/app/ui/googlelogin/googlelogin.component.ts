  ...
  constructor(
    ...
    private nickNameService: NicknameService,
      ...
      googleApi.userProfileSubject.subscribe( info => {
        ...
        (<HTMLInputElement>document.getElementById("nom")).value =this.userInfo?.info?.email;
        (<HTMLInputElement>document.getElementById("nomSign")).value =this.userInfo?.info?.email;
        (<HTMLInputElement>document.getElementById("nickname")).value =this.nickNameService.getNickname();
